...
# add_action('register_form', extend_user_profile); // Remove "#" if user can fill out the form on registration.
# add_action('register_post', extended_user_profile_registration_save); // Remove "#" if user can fill out the form on registration page.
...
global $wpdb;
	...
	// Switch between users.php and profile.php
	if ( $_POST['user_id'] ) {
		$id = $_POST['user_id'];
	}
